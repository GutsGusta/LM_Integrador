...
<form action="./data/insert.php" method="POST">
        ...
        <input type="hidden" name="id_profissional" value="<?php echo htmlspecialchars($id_profissional_avaliado); ?>">
        <input type="hidden" name="id_cliente" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
        
        <input type="hidden" name="nome_profissional" value="<?php echo htmlspecialchars($nome_profissional_avaliado); ?>">
