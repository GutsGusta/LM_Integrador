<header>
    <nav class="header__nav">
        <div class="nav__left">
            <a href="index.php"><img src="uploads/Logo-LM.png" alt="LM" class="logo"></a>
        ...
        <div class="nav__right">
            <a class="nav_link" href="orcamento.php"></a><button class="btn-orcamento">Solicitar Orçamento</button></a>
